...
HXTI（海克斯科技_科研民工_人格测试）中一共包含30个人格类型和1个隐藏人格，这个隐藏人格有着悲惨的命运，希望你不会测出这个人格。

## 特性（该特性说明是pingfanfan的SBTI项目的原版说明，大致逻辑可以看一下）

- 🧠 **27种人格类型** — 26种标准类型 + 1种隐藏/兜底类型
- 📊 **15个评估维度** — 自我、情感、态度、行动、社交五大模型
- 🎯 **曼哈顿距离匹配** — 基于15维向量的匹配算法(但完全不保障科学性，因为这个测试甚至比普通的心理学测试还离谱，切莫当真)
- 🍺 **隐藏彩蛋** — 受害者人格触发机制
- 📱 **移动端优先** — 响应式设计，手机体验友好
